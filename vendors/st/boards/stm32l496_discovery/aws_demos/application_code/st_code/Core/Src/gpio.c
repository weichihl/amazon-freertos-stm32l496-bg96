...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOI, ARD_D4_Pin|MDM_SIM_SELECT_1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOG, ARD_D8_Pin|ARD_D2_Pin|ARD_D7_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PH7 PH3 PH6 PH0 
                           PH1 */
  GPIO_InitStruct.Pin = GPIO_PIN_7|GPIO_PIN_3|GPIO_PIN_6|GPIO_PIN_0 
                          |GPIO_PIN_1;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOH, &GPIO_InitStruct);
